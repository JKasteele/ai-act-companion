...
|---|------|-----------|---------------------|
| 1 | 0–8s | Landing page. Linger on the **amber countdown** ("… days until High-risk (Annex III) obligations apply, 2 Dec 2027") and the "Knowledge base reviewed …" stamp under it. | "The EU AI Act's high-risk rules apply on 2 December 2027 — the Digital Omnibus moved the date, and the tool moved with it. AI Act Companion helps you get ready — locally, with no black box." |
...
| 3 | 16–28s | Result view: the **High-risk** tier badge, the cited findings, the **Applies from 2 Dec 2027** line. Scroll to the **AI security lens** with the **Critical** severity badge. | "It cites the exact Article and Annex for every verdict — and rates AI-security risk by the architecture, not a checkbox. Here: Critical, because the model is the only access-control boundary." |
