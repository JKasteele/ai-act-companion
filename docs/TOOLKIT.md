> Reference for the original toolkit, now available at `/classic`. Start with the [project overview](../README.md) for the evidence workspace.
...
> [docs/DEPLOY-HF-SPACE.md](DEPLOY-HF-SPACE.md) for how it is hosted.
>
> 📂 **[Browse example reports →](examples)** — real generated artifacts
...
![AI Act Companion — classify a system, then review the architecture-aware AI security severity, the prioritised red-team test plan, the matching defensive control catalogue, the OWASP GenAI Data Security findings, and the NIST CSF 2.0 / ISO 27001 framework matrix](img/demo.gif)
...
|---|---|---|
| ![Classification result](img/result.png) | ![Architecture-aware severity in the AI security lens](img/security.png) | ![Architecture-aware red-team test plan, prioritised by severity](img/redteam.png) |

| Control catalogue (defense) | OWASP GenAI Data Security | CSF 2.0 / ISO 27001 matrix |
|---|---|---|
| ![Defensive control catalogue, each control validated by a red-team test](img/controls.png) | ![OWASP GenAI Data Security risks (DSGAI01–21)](img/datasec.png) | ![NIST CSF 2.0 / ISO 27001 framework integration matrix](img/framework-matrix.png) |

| Conformity tracker + penalties | AI assist (human-in-the-loop) | |
|---|---|---|
| ![Obligations tracker with Art. 99 penalties](img/report.png) | ![AI assist](img/ai-assist.png) | |
...
human-in-the-loop review is mandatory. See **[docs/COPILOT.md](COPILOT.md)**
