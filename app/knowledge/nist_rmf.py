...
SUBCATEGORIES = [
    ...
    ("MAP 2.3", "MAP",
     "Scientific integrity and test, evaluation, validation and verification "
     "(TEVV) considerations are identified and documented.",
     "EU AI Act Art. 9(2)"),
    ("MAP 5.1", "MAP",
    ...
    ("MEASURE 2.10", "MEASURE",
     "Privacy risk - including re-identification and data leakage - is examined and documented.",
     "EU AI Act Art. 10; GDPR"),
    ("MANAGE 1.3", "MANAGE",
